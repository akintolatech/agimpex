"""
Django settings for agimpex project.
...
SECRET_KEY = 'django-insecure-9m8e4eix7t+(@f59vy1w7kfy&i4k@+!2hltqjjjg5#chh+z$#0'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'shop.context_processors.favorite_products',
            ],
        },
    },
]

WSGI_APPLICATION = 'agimpex.wsgi.application'
